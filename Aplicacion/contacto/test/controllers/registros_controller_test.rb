...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { cargo: @registro.cargo, correo: @registro.correo, nombre: @registro.nombre } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { cargo: @registro.cargo, correo: @registro.correo, nombre: @registro.nombre } }
