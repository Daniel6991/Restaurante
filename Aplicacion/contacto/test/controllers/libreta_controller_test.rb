...
class LibretaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libretum" do
    assert_difference('Libretum.count') do
      post libreta_url, params: { libretum: { edad: @libretum.edad, nombre: @libretum.nombre } }
    end
  ...
  test "should update libretum" do
    patch libretum_url(@libretum), params: { libretum: { edad: @libretum.edad, nombre: @libretum.nombre } }
